...
const GenderPicker = () => {
  return (
    <div className="w-[75%] flex mt-[-30px] flex-col gap-2 overflow-hidden rounded-md p-2 items-start shadow-sm shadow-[#00000050]">
      <span className="text-center font-mono text-base font-black uppercase text-white">Please select your gender</span>
